...
class _top_trading_packages_viewallState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: destination_id != "" ? FutureBuilder<get_destinationdata_model>(
                          ...
                          onTap: () async {
                            ...
                            if(server.packages?[0].sId != null){
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => PackageDetails(packageId: server!.packages![0].sId.toString(),)));
                            }
