                ...
                return (snapshot.hasData)
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          int? count = server?.packages!.length;
                          ...
                          return SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, packageIndex) {
                                var _travelby =
                                    server?.packages?[packageIndex].travelBy;

                                return Padding(
                                    padding: EdgeInsets.fromLTRB(5, 5, 5, 5),
                                    child: InkWell(
                                      onTap: () async {
                                        var packageId = server
                                                ?.packages?[packageIndex].sId
                                                .toString() ??
                                            '';
                                      ...
                                      child: Container(
                                        child: InkWell(
                                          onTap: () async {
                                            ...
                                            pref.setString(
                                                "Packages_id",
                                                server!.packages![0].sId // cng
                                                    .toString());

                                            if (server.packages?[0].sId != //cng
                                                null) {
